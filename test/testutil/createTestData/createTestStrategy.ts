...
export const createTestStrategy = (id: string, checkArgs: (args: StrategyFunctionArgs<any, any, Report>) => void, strategyResult: (factory: StrategyFunctionArgs<any, any, Report>['tradeFactory']) => StrategyFunctionResult<any>,): Strategy<any, any, Report> => {
  return {
    id,
